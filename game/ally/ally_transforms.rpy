...
init -46:
    transform enterTrans():
        ...
        xysize (200, 200) xalign 0.3 yalign 0.5 xoffset -600 alpha 0.0
        linear 1.0 xoffset 0 alpha 1.0

    transform idleTrans():

        xysize (200, 200) xalign 0.3 yalign 0.5
    ...
    transform moveBackTrans():
        ...
        xysize (200, 200) xalign 0.6 yalign 0.5
    ...
    transform deathTrans():
        ...
        xysize (200, 200) xoffset 0 align (0.3, 0.5)
        linear 1.5 xoffset - 1000

    transform snowflakeTransform():
        xysize (200, 200) xoffset -1000 yoffset -1000 yalign 1.0
        pause 1.0
    ...
    transform slideFinishTrans():
        xysize (200, 200) xalign 0.5 yalign 0.5
        pause 0.1
    ...
    transform spellTransform():
        ...
        xysize (200, 200) yalign 0.5 xoffset -510
